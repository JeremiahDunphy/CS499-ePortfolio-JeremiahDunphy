...
function ContactManager() {
    ...
    const validatePhone = (phone) => {
        ...
        // Also check for minimum length (at least 10 digits)
    ...
    const validateId = (id) => {
        ...
        // Check if ID already exists (for new contacts only)
        if (!editingContact && contacts.find(c => c.id === id.trim())) {
    ...
    const validateForm = (contact) => {
        ...
        } else if (!editingContact && contacts.find(c => c.id === contact.id.trim())) {
        ...
        // Required field validations for phone and email
    ...
    const fetchContacts = async () => {
        ...
        try {
            ...
            setContacts(data.sort((a, b) => a.id.localeCompare(b.id)));
        } catch (error) {
